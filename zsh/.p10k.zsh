# Generated by Powerlevel10k configuration wizard on 2023-07-22 at 22:47 PDT.
...
() {
  ...
  '~/Development/bezhermoso(|/*)'  PERSONAL     '')

  #   Styling for PERSONAL.
  typeset -g POWERLEVEL9K_DIR_PERSONAL_VISUAL_IDENTIFIER_EXPANSION=''
  # typeset -g POWERLEVEL9K_DIR_PERSONAL_FOREGROUND=4
  # typeset -g POWERLEVEL9K_DIR_PERSONAL_SHORTENED_FOREGROUND=4
  # typeset -g POWERLEVEL9K_DIR_PERSONAL_ANCHOR_FOREGROUND=4
  #
  #   Styling for TERRAFORM
  typeset -g POWERLEVEL9K_DIR_TERRAFORM_VISUAL_IDENTIFIER_EXPANSION='󱁢'
  typeset -g POWERLEVEL9K_DIR_TERRAFORM_FOREGROUND=13
  typeset -g POWERLEVEL9K_DIR_TERRAFORM_SHORTENED_FOREGROUND=13
  typeset -g POWERLEVEL9K_DIR_TERRAFORM_ANCHOR_FOREGROUND=13

  #   Styling for CLOUD_CD
  typeset -g POWERLEVEL9K_DIR_CLOUD_CD_VISUAL_IDENTIFIER_EXPANSION='󰅧'
  typeset -g POWERLEVEL9K_DIR_CLOUD_CD_FOREGROUND=14
  typeset -g POWERLEVEL9K_DIR_CLOUD_CD_SHORTENED_FOREGROUND=14
  typeset -g POWERLEVEL9K_DIR_CLOUD_CD_ANCHOR_FOREGROUND=14

  #   Styling for GOLANG
  typeset -g POWERLEVEL9K_DIR_GOLANG_VISUAL_IDENTIFIER_EXPANSION=''
  # typeset -g POWERLEVEL9K_DIR_GOLANG_FOREGROUND=14
  # typeset -g POWERLEVEL9K_DIR_GOLANG_SHORTENED_FOREGROUND=14
  # typeset -g POWERLEVEL9K_DIR_GOLANG_ANCHOR_FOREGROUND=14
  ...
  typeset -g POWERLEVEL9K_VCS_DISABLED_WORKDIR_PATTERN='~/Development/java'
