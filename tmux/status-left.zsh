...
tmux_session_prefix_colors=(colour24 colour29)

tmux_session_segment="#[bg=$tmux_session_prefix_colors[1],bold]#{?client_prefix,,$tmux_session_name}"
tmux_session_segment="$tmux_session_segment#{?client_prefix,,}"

tmux_session_prefix_segment="#[bg=$tmux_session_prefix_colors[2],fg=white,bold]#{?client_prefix,$tmux_session_name,}"
